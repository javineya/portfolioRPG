...
// TODO:    Put skillInfo in array for mapping.
const defaultState = [
    {   name: 'Make a Plan!', 
        ...
        target: 'pdHead',
        tileImages: ['./images/IconJavaScript', './images/IconHTML', './images/IconCSS'],
        tileTargets: ['tile0', 'tile1', 'tile2'],
        skillInfo: 'I found freeCodeCamp, and spent 8 hours doing exercises. What a way to spend my birthday.'},
    ...
    {   name: 'Harvard CS50x', 
        ...
        target: 'pdLegs',
        tileImages: ['./images/IconC', './images/IconPython'],
        tileTargets: ['tile4', 'tile5'],
    ...
    {   name: 'Legacy Front End Certification', 
        ...
        target: 'pdFeet',
        tileImages: ['./images/TileTest'],
        tileTargets: ['tile4', 'tile5', 'tile6', 'tile7', 'tile8'],
